...
def _get_regex_patterns():
    ...
    return {
        'added': [
            ...
            r'\badds\b', r'\badded\b', r'\badding\b',
            r'\baddition\b(?!al)',  # 'addition' but not 'additional'
            r'\bcreate\b', r'\bcreates\b', r'\bcreating\b', r'\bcreated\b',
            r'\benable\b', r'\benables\b', r'\benabling\b', r'\benabled\b',
            r'\bsupport\b', r'\bsupports\b', r'\badding support\b',
            r'\bimplement\b', r'\bimplements\b', r'\bimplementing\b',
            r'\bintroduce\b', r'\bintroduces\b', r'\bintroducing\b', r'\bintroduced\b',
            r'^new\b', r'\bnew feature\b', r'\bnew functionality\b',
            r'^feat:\s*add\b', r'^feat:\s*implement\b'
        ],
        'removed': [
        ...
        'fixed': [
            ...
            r'\bbug\b', r'\bbugs\b', r'\bpatch\b',
            r'\bresolve\b', r'\bresolves\b', r'\bresolved\b',
            r'\baddress\b.*\b(error|issue|problem)\b',
            r'\brobustness\b', r'\bstability\b', r'\bdegenerate\b',
            r'\bprecision\b', r'\bnumerical\b', r'\bfallback\b',
            r'\berror handling\b', r'\bconsistency check\b'
        ],
        'changed': [
            r'\bupdate\b', r'\bupdates\b', r'\bupdating\b',
            r'\brefactor\b', r'\brefactors\b', r'\brefactoring\b',
            r'\bchange\b', r'\bchanges\b', r'\bchanging\b', r'\bbump\b',
            ...
            r'\bperformance\b', r'\bmsrv\b', r'\bminimum supported rust version\b'
        ],
        'deprecated': [
            r'\bdeprecate\b', r'\bdeprecates\b', r'\bdeprecating\b', r'\bdeprecated\b'
        ],
        'security': [
            r'\bsecurity\b', r'\bvulnerability\b', r'\bvulnerabilities\b',
...
def process_and_output_categorized_entries(entries, output_lines):
    ...
    for section in section_order:
        any_sections_output = _add_section_with_entries(
            output_lines, section_names[section],
            categorized[section], any_sections_output
        )
...
def _process_changelog_lines(lines):
    ...
    while line_index < len(lines):
        ...
        if is_release_end or is_file_end:
            ...
            # Reset section state
            section_state.update({'in_changes_section': False,
                                'in_fixed_issues': False,
                                'in_merged_prs_section': False})
        ...
        if ((section_state['in_changes_section'] or section_state['in_fixed_issues']) and
                re.match(r'^- \*\*', line)):
