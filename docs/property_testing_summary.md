...
- **Delaunay Property** (13 property tests):
...
- **DelaunayTriangulation layer** (`proptest_delaunay_triangulation.rs`): 17 tests (4 passing structural, 9 active, 4 ignored)
...
- **Core architectural tests**: 85 tests (77 passing, 4 ignored, 4 passing structural)
