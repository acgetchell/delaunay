...
- Improve type alias consistency and test coverage [`f7203df`](https://github.com/acgetchell/delaunay/commit/f7203df88008dd51431d25708caaf0f06b51861b)
...
- Use semantic type aliases for internal buffers [`f7203df`](https://github.com/acgetchell/delaunay/commit/f7203df88008dd51431d25708caaf0f06b51861b)
...
- Fix Delaunay violations in cavity-based insertion [`da473c8`](https://github.com/acgetchell/delaunay/commit/da473c8c66557b18217ddb45520127dee49bae49)
...
- Improve error handling and performance in insertion algorithm
...
- Surface duplicate boundary facets as errors instead of silent filtering
  [`a6ec3fa`](https://github.com/acgetchell/delaunay/commit/a6ec3fae7423e9245018e7fb071bd92fbb70283e)
...
- Add AI tool acknowledgements and clarify bbox helpers [`a6ec3fa`](https://github.com/acgetchell/delaunay/commit/a6ec3fae7423e9245018e7fb071bd92fbb70283e)
...
- Rename saturating_* helpers to bbox_* and clarify float semantics
  [`a6ec3fa`](https://github.com/acgetchell/delaunay/commit/a6ec3fae7423e9245018e7fb071bd92fbb70283e)
...
#### Improved Error Messages - Follow-up

- Changed post-filtering error to "No boundary facets available after filtering"
- More accurate since empty result can come from filtering, deduplication, or
  empty input

#### Performance Optimization - Follow-up 2
...
#### Breaking API Changes - Follow-up
...
#### Performance Optimization - Follow-up 3

- Use SmallBuffer (stack-allocated, falls back to heap) for typical D+1 facets
- Faster than Vec for small collections (common case in D dimensions)
- Maintains O(n) duplicate detection with FastHashSet

#### Implementation Details - Follow-up
...
- The old naming suggested these functions did something special, when
  they're just plain +/- operations with overflow-to-infinity semantics
- Add rollback on cell creation failure and fix property test
  [`a6ec3fa`](https://github.com/acgetchell/delaunay/commit/a6ec3fae7423e9245018e7fb071bd92fbb70283e)
  ...
  Fixes edge cases where invalid facet sharing or degenerate geometry
  would previously cause TDS invariant violations.
- Fix preventive facet filter and UUID/construction_state bugs
  [`a6ec3fa`](https://github.com/acgetchell/delaunay/commit/a6ec3fae7423e9245018e7fb071bd92fbb70283e)
...
#### Preventive Facet Filter Fix (CRITICAL) - Follow-up
...
#### UUID Duplicate Detection Fix - Follow-up
...
#### Construction State Accuracy Fix - Follow-up
...
- Optimize deduplication and facet filtering hot paths [`a6ec3fa`](https://github.com/acgetchell/delaunay/commit/a6ec3fae7423e9245018e7fb071bd92fbb70283e)

  Reduce allocations in deduplication and improve hashing performance in
  the preventive facet filter's inner loop.

#### Deduplication Optimization - Follow-up
...
#### Facet Filter Optimization - Follow-up
...
#### Documentation Clarification - Follow-up
