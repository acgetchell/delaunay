...
This repository has migrated changelog generation to [`git-cliff`](https://github.com/orhun/git-cliff) using `cliff.toml` at the repository root (invoked via `just changelog` / `uv run changelog-utils generate`).
