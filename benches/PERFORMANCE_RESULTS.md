...
**Last Updated**: 2025-09-22 18:26:50 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: 16321db9427557c7dadfc1c171f1005547c1bd56
...
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 616 ns | 607 ns | 479 ns | **insphere_lifted** |
| Boundary vertex | 608 ns | 616 ns | 472 ns | **insphere_lifted** |
| Far vertex | 604 ns | 586 ns | 468 ns | **insphere_lifted** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 922 ns | 1.4 µs | 717 ns | **insphere_lifted** |
| Boundary vertex | 898 ns | 1.4 µs | 727 ns | **insphere_lifted** |
| Far vertex | 968 ns | 1.5 µs | 716 ns | **insphere_lifted** |
...
| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 1.8 µs | 3.0 µs | 1.6 µs | **insphere_lifted** |
| Boundary vertex | 1.8 µs | 2.9 µs | 1.5 µs | **insphere_lifted** |
| Far vertex | 1.9 µs | 3.0 µs | 1.6 µs | **insphere_lifted** |
...
- `insphere_lifted`: 952 ns (fastest)
