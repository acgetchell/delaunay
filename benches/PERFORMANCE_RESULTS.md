...
**Last Updated**: 2025-12-17 01:29:30 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: 3ac8b111a6c5ae33f069a32764718bfe4707db22
...
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 48 ns | 24 ns | 38 ns | **insphere_distance** |
| Boundary vertex | 3 ns | 24 ns | 38 ns | **insphere** |
...
| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 186 ns | 64 ns | 143 ns | **insphere_distance** |
| Boundary vertex | 2 ns | 65 ns | 142 ns | **insphere** |
| Far vertex | 139 ns | 64 ns | 154 ns | **insphere_distance** |

#### Single Query Performance (5D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 261 ns | 88 ns | 195 ns | **insphere_distance** |
| Boundary vertex | 4 ns | 88 ns | 195 ns | **insphere** |
