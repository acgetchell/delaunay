...
**Last Updated**: 2026-03-10 19:58:24 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: fed429f281cb2bc2e4a97cd99ac1770ade76a202
...
#### Version 0.7.2 Results (2026-03-10)

#### Single Query Performance (2D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 17 ns | 26 ns | 8 ns | **insphere_lifted** |
| Boundary vertex | 2 ns | 26 ns | 2.8 µs | **insphere** |
| Far vertex | 18 ns | 25 ns | 8 ns | **insphere_lifted** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 136 ns | 38 ns | 20 ns | **insphere_lifted** |
| Boundary vertex | 2 ns | 38 ns | 7.3 µs | **insphere** |
| Far vertex | 114 ns | 38 ns | 20 ns | **insphere_lifted** |

#### Single Query Performance (4D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 192 ns | 63 ns | 78 ns | **insphere_distance** |
| Boundary vertex | 2 ns | 63 ns | 14.2 µs | **insphere** |
| Far vertex | 160 ns | 64 ns | 87 ns | **insphere_distance** |

#### Single Query Performance (5D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 270 ns | 86 ns | 107 ns | **insphere_distance** |
| Boundary vertex | 2 ns | 86 ns | 25.3 µs | **insphere** |
| Far vertex | 204 ns | 86 ns | 115 ns | **insphere_distance** |
...
2. **insphere_lifted** - (best in 2D, 3D) - ~1.0x average vs fastest
3. **insphere** - ~2.6x slower than fastest on average
...
- **`insphere_lifted`**: (best in 2D, 3D) - ~1.0x average vs fastest
...
- `insphere_distance`: 53 ns (best in 4D, 5D)
- `insphere_lifted`: 55 ns (best in 2D, 3D)
- `insphere`: 139 ns (third fastest)
