...
**Last Updated**: 2025-10-29 02:29:53 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: 49f5eb5d90bb0a5eb26166986347b73038100de1
...
#### Version 0.5.2 Results (2025-10-28)

#### Single Query Performance (2D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 594 ns | 588 ns | 460 ns | **insphere_lifted** |
| Boundary vertex | 601 ns | 598 ns | 464 ns | **insphere_lifted** |
| Far vertex | 603 ns | 589 ns | 464 ns | **insphere_lifted** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 887 ns | 1.4 µs | 714 ns | **insphere_lifted** |
| Boundary vertex | 895 ns | 1.4 µs | 715 ns | **insphere_lifted** |
| Far vertex | 899 ns | 1.4 µs | 713 ns | **insphere_lifted** |

#### Single Query Performance (4D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 1.3 µs | 1.8 µs | 1.0 µs | **insphere_lifted** |
...
- `insphere_lifted`: 924 ns (fastest)
