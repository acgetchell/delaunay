...
**Last Updated**: 2025-09-24 05:07:38 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: 1445afc3d898bb5907f0dffe8c38de445a6a71ed
...
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 584 ns | 585 ns | 450 ns | **insphere_lifted** |
| Boundary vertex | 587 ns | 585 ns | 453 ns | **insphere_lifted** |
| Far vertex | 597 ns | 591 ns | 455 ns | **insphere_lifted** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 880 ns | 1.4 µs | 698 ns | **insphere_lifted** |
| Boundary vertex | 904 ns | 1.4 µs | 703 ns | **insphere_lifted** |
| Far vertex | 899 ns | 1.4 µs | 701 ns | **insphere_lifted** |

#### Single Query Performance (4D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 1.2 µs | 1.7 µs | 1.0 µs | **insphere_lifted** |
| Boundary vertex | 1.2 µs | 1.7 µs | 1.1 µs | **insphere_lifted** |
...
| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 1.7 µs | 2.9 µs | 1.5 µs | **insphere_lifted** |
| Boundary vertex | 1.7 µs | 2.9 µs | 1.5 µs | **insphere_lifted** |
| Far vertex | 1.7 µs | 2.9 µs | 1.5 µs | **insphere_lifted** |
...
- `insphere_lifted`: 916 ns (fastest)
- `insphere`: 1.1 µs (balanced)
- `insphere_distance`: 1.6 µs (transparent)
