...
**Last Updated**: 2026-01-12 21:47:40 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: 44d3add45bdac8daff9cff6b686929959ccf84a3
...
#### Version 0.7.0 Results (2026-01-12)

#### Single Query Performance (2D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 49 ns | 24 ns | 37 ns | **insphere_distance** |
| Boundary vertex | 3 ns | 23 ns | 37 ns | **insphere** |
| Far vertex | 39 ns | 24 ns | 41 ns | **insphere_distance** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 126 ns | 40 ns | 72 ns | **insphere_distance** |
| Boundary vertex | 4 ns | 40 ns | 71 ns | **insphere** |
| Far vertex | 92 ns | 40 ns | 77 ns | **insphere_distance** |

#### Single Query Performance (4D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 184 ns | 65 ns | 145 ns | **insphere_distance** |
| Boundary vertex | 3 ns | 65 ns | 143 ns | **insphere** |
| Far vertex | 140 ns | 65 ns | 155 ns | **insphere_distance** |

#### Single Query Performance (5D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 261 ns | 88 ns | 196 ns | **insphere_distance** |
| Boundary vertex | 4 ns | 88 ns | 197 ns | **insphere** |
| Far vertex | 191 ns | 87 ns | 208 ns | **insphere_distance** |
...
2. **insphere_lifted** - ~2.1x slower than fastest on average
3. **insphere** - ~2.5x slower than fastest on average
...
- `insphere_distance`: 54 ns ((best in 2D, 3D, 4D, 5D))
- `insphere_lifted`: 116 ns (second fastest)
- `insphere`: 135 ns (third fastest)
