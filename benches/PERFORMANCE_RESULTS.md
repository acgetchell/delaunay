...
**Last Updated**: 2025-12-17 04:20:55 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: 7ab0bdffdb04f7400646849febd71659b5fffdea
...
#### Version 0.6.1 Results (2025-12-16)
...
| Far vertex | 39 ns | 23 ns | 41 ns | **insphere_distance** |
...
| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 184 ns | 64 ns | 143 ns | **insphere_distance** |
| Boundary vertex | 2 ns | 65 ns | 142 ns | **insphere** |
| Far vertex | 138 ns | 65 ns | 154 ns | **insphere_distance** |

#### Single Query Performance (5D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 259 ns | 88 ns | 196 ns | **insphere_distance** |
| Boundary vertex | 4 ns | 89 ns | 194 ns | **insphere** |
| Far vertex | 189 ns | 88 ns | 204 ns | **insphere_distance** |
