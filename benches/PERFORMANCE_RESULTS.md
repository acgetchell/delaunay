...
**Last Updated**: 2025-09-22 03:04:16 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: dc530025791f61266269196fd0cc7fb90598efba
...
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 591 ns | 580 ns | 456 ns | **insphere_lifted** |
| Boundary vertex | 621 ns | 594 ns | 479 ns | **insphere_lifted** |
| Far vertex | 608 ns | 586 ns | 473 ns | **insphere_lifted** |
...
| Boundary vertex | 911 ns | 1.4 µs | 702 ns | **insphere_lifted** |
| Far vertex | 908 ns | 1.4 µs | 753 ns | **insphere_lifted** |
...
| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 1.8 µs | 2.9 µs | 1.6 µs | **insphere_lifted** |
| Boundary vertex | 1.7 µs | 2.9 µs | 1.5 µs | **insphere_lifted** |
| Far vertex | 1.7 µs | 2.9 µs | 1.6 µs | **insphere_lifted** |
...
- `insphere_lifted`: 945 ns (fastest)
