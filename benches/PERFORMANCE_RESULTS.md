...
**Last Updated**: 2026-02-20 21:15:30 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: b071fb787bf06ff196fade35fd5dab180822985b
...
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 50 ns | 31 ns | 40 ns | **insphere_distance** |
| Boundary vertex | 3 ns | 32 ns | 40 ns | **insphere** |
| Far vertex | 40 ns | 31 ns | 44 ns | **insphere_distance** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 127 ns | 56 ns | 74 ns | **insphere_distance** |
| Boundary vertex | 3 ns | 56 ns | 74 ns | **insphere** |
...
| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 188 ns | 77 ns | 147 ns | **insphere_distance** |
| Boundary vertex | 3 ns | 76 ns | 146 ns | **insphere** |
| Far vertex | 144 ns | 76 ns | 159 ns | **insphere_distance** |

#### Single Query Performance (5D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 264 ns | 92 ns | 206 ns | **insphere_distance** |
| Boundary vertex | 4 ns | 91 ns | 203 ns | **insphere** |
| Far vertex | 196 ns | 91 ns | 211 ns | **insphere_distance** |
...
- `insphere_distance`: 64 ns ((best in 2D, 3D, 4D, 5D))
