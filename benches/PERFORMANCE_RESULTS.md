...
**Last Updated**: 2025-12-07 01:13:06 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: 37845f505aa665bfb5c5fa7d8d414898a3024de3
...
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 110 ns | 79 ns | 41 ns | **insphere_lifted** |
| Boundary vertex | 3 ns | 78 ns | 42 ns | **insphere** |
| Far vertex | 102 ns | 78 ns | 42 ns | **insphere_lifted** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 207 ns | 94 ns | 166 ns | **insphere_distance** |
| Boundary vertex | 4 ns | 96 ns | 161 ns | **insphere** |
| Far vertex | 203 ns | 97 ns | 166 ns | **insphere_distance** |

#### Single Query Performance (4D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 276 ns | 170 ns | 224 ns | **insphere_distance** |
| Boundary vertex | 4 ns | 173 ns | 226 ns | **insphere** |
| Far vertex | 286 ns | 171 ns | 228 ns | **insphere_distance** |

#### Single Query Performance (5D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 5D | 351 ns | 350 ns | 298 ns | **insphere_lifted** |
| Boundary vertex | 4 ns | 358 ns | 301 ns | **insphere** |
| Far vertex | 356 ns | 354 ns | 308 ns | **insphere_lifted** |
...
3. **insphere_lifted** - (slowest) - ~1.2x slower than fastest
...
- `insphere`: 159 ns (fastest)
- `insphere_distance`: 175 ns (balanced)
- `insphere_lifted`: 183 ns (transparent)
