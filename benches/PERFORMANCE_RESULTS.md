...
**Last Updated**: 2025-10-31 19:04:15 UTC
**Generated By**: benchmark_utils.py
**Git Commit**: a6ec3fae7423e9245018e7fb071bd92fbb70283e
...
#### Version 0.5.3 Results (2025-10-31)

#### Single Query Performance (2D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 2D | 593 ns | 594 ns | 453 ns | **insphere_lifted** |
| Boundary vertex | 593 ns | 588 ns | 469 ns | **insphere_lifted** |
| Far vertex | 603 ns | 579 ns | 478 ns | **insphere_lifted** |

#### Single Query Performance (3D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 3D | 901 ns | 1.4 µs | 713 ns | **insphere_lifted** |
| Boundary vertex | 938 ns | 1.4 µs | 720 ns | **insphere_lifted** |
| Far vertex | 909 ns | 1.4 µs | 704 ns | **insphere_lifted** |

#### Single Query Performance (4D)

| Test Case | insphere | insphere_distance | insphere_lifted | Winner |
|-----------|----------|------------------|-----------------|---------|
| Basic 4D | 1.3 µs | 1.8 µs | 1.1 µs | **insphere_lifted** |
| Boundary vertex | 1.3 µs | 1.8 µs | 1.1 µs | **insphere_lifted** |
| Far vertex | 1.3 µs | 1.8 µs | 1.1 µs | **insphere_lifted** |
...
| Boundary vertex | 1.8 µs | 2.9 µs | 1.6 µs | **insphere_lifted** |
| Far vertex | 1.8 µs | 2.9 µs | 1.6 µs | **insphere_lifted** |
...
- `insphere_lifted`: 947 ns (fastest)
