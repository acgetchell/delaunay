...
- **Updates `generate_baseline.sh` to collect git commit info even when git isn't available and fixes an issue that prevented
  benchmarks from running in dev mode.** [`5fb31b1`](https://github.com/acgetchell/delaunay/commit/5fb31b1)
...
- **fix: improve release tooling and documentation** [`1b1b07f`](https://github.com/acgetchell/delaunay/commit/1b1b07f20f8819a033eb94f951ce7e38e1bc6a70)

- **docs: fix markdown formatting in RELEASING.md** [`9585d60`](https://github.com/acgetchell/delaunay/commit/9585d607eed4fc218a23aaee82648efc72e47fec)
