...
## [v0.7.2](https://github.com/acgetchell/delaunay/compare/v0.7.1...v0.7.2) - 2026-03-01
...
- **Changed: Update MSRV to 1.93.1 and `sysinfo` dependency** [`a2a42d5`](https://github.com/acgetchell/delaunay/commit/a2a42d5)

### Merged Pull Requests

- feat: exact insphere predicates with f64 fast filter [`#245`](https://github.com/acgetchell/delaunay/pull/245)

- feat: use exact-sign orientation in robust_orientation() [`#244`](https://github.com/acgetchell/delaunay/pull/244)

- feat: use exact arithmetic for orientation predicates (#235) [`#236`](https://github.com/acgetchell/delaunay/pull/236)

- perf: switch FastKernel to insphere_lifted and enable LTO [`#234`](https://github.com/acgetchell/delaunay/pull/234)

- refactor: deduplicate D<4 repair fallback and improve diagnostics [`#232`](https://github.com/acgetchell/delaunay/pull/232)

- fix: resolve 3D seeded bulk construction orientation convergence failure [`#228`](https://github.com/acgetchell/delaunay/pull/228)
...
- **Add \`insphere\_from\_matrix\` helper in predicates.rs using a 3-stage** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

  approach: f64 fast filter → exact Bareiss → f64 fallback

- **Add near-cocircular and near-cospherical exact-sign tests** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

- **Add near-degenerate 2D and 3D tests that exercise the exact-sign path** [`2869cfe`](https://github.com/acgetchell/delaunay/commit/2869cfe)

  Closes #241

- **Add \`matrix\_zero\_like()\` helper for creating same-sized zero matrices** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)
  - Tests
    - Add orientation\_from\_matrix unit tests (positive, negative, degenerate,
    - Add near-degenerate exact orientation tests for 2D and 3D (2^-50
    - Add truly-degenerate tests (collinear 2D, coplanar 3D)
  - Other
    - Add \`orientation\_from\_matrix()\` using \`det\_sign\_exact()\` with a

- **docs(predicates): add robustness caveats and parity branch tests** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)
  - Tests
    - Add test\_insphere\_lifted\_parity\_branch\_positive\_orientation
    - Add test\_insphere\_lifted\_parity\_branch\_negative\_orientation
  - Other
    - Cargo.toml: Add \[profile.release\] with lto="thin" and codegen-units=1
    - Add performance sections to insphere(), insphere\_distance(), and insphere\_lifted()
    - Add robustness caveat to insphere\_distance() recommendation (lines 192-196)
    - Add robustness caveat to insphere() performance section (lines 297-302)
    - Add new "Robustness" section to insphere\_lifted() docs (lines 500-505)

- **Add test\_construction\_options\_global\_repair\_fallback\_toggle unit** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  test verifying the without_global_repair_fallback builder toggle.

- **Add RobustKernel to prelude::query exports** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

- **Add make\_robust\_kernel<T>() factory in triangulation\_generation.rs that** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)
...
- **feat: exact insphere predicates with f64 fast filter** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

- **Update \`insphere\`, \`insphere\_lifted\`, \`adaptive\_tolerance\_insphere\`,** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

  and `conditioned_insphere` to use exact-sign path

- **Switch convex hull performance test to FastKernel to avoid 5×5** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

  exact Bareiss on cospherical inputs

- **Document lint suppression preference (\`expect\` over \`allow\`) in** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

  docs/dev/rust.md

  Closes #240

- **Changed: simplify robust insphere logic and optimize test suites** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)
...
- **Changed: refine exact predicate fallbacks and optimize matrix reuse** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)
...
- **Changed: correct matrix norm description in predicate comments** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)
...
- **Changed: enforce dimension equality in matrix predicates** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

  Add debug assertions to ensure the logical dimension k matches the matrix
  dimension N in insphere and orientation predicates. Because underlying
  exact arithmetic operates on the full matrix, callers must satisfy this
  invariant. Update associated tests to use matching dimensions. This is
  an internal change.

- **Changed: update non-finite fallback description in insphere predicates** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

  Update documentation for insphere predicates to clarify that non-finite
  inputs result in a boundary or degenerate state rather than a
  floating-point sign classification. This is an internal change.

  ---------

- **feat: use exact-sign orientation in robust\_orientation()** [`2869cfe`](https://github.com/acgetchell/delaunay/commit/2869cfe)
...
- **Make \`orientation\_from\_matrix\` pub(crate) so robust\_predicates can call it** [`2869cfe`](https://github.com/acgetchell/delaunay/commit/2869cfe)

- **Changed: ignore slow higher-dimensional Delaunay proptests** [`2869cfe`](https://github.com/acgetchell/delaunay/commit/2869cfe)
...
- **Changed: add tests for robust\_orientation sign and error handling** [`2869cfe`](https://github.com/acgetchell/delaunay/commit/2869cfe)

  Verify that robust_orientation correctly identifies positive 2D
  triangles and handles non-finite configuration values by returning an
  error. This is an internal change.

- **Changed: simplify epsilon constants in robust orientation tests** [`2869cfe`](https://github.com/acgetchell/delaunay/commit/2869cfe)

  Replace bitwise f64 representation with a more readable power-of-two
  expression in robust orientation tests. This is an internal change.

- **feat: use exact arithmetic for orientation predicates (#235)** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)
...
- **\`simplex\_orientation()\` now delegates to \`orientation\_from\_matrix()\`,** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  eliminating manual tolerance comparison

  insphere_lifted optimization:

- **Reuse the relative-coordinate block already in the lifted matrix for** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  orientation instead of re-converting all D+1 simplex points

- **Combine the dimension-parity sign and (-1)^D orientation correction** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  into a single simplified formula: det_norm = −det × rel_sign

- **Reduce MAX\_STACK\_MATRIX\_DIM from 18 to 7 (matching tested D≤5 range)** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

- **Replace 19 hand-written match arms with a compact repetition macro** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

- **Mark slow periodic 3D builder test as #\[ignore\]** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  Closes #235

- **Changed: modularize developer docs and refine orientation logic** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  Split the monolithic `AGENTS.md` into specialized guides under `docs/dev/`
  covering Rust conventions, testing, and workflows. Refactor the
  `orientation_from_matrix` predicate to use idiomatic error handling
  and update test diagnostics. This is an internal change.

- **Changed: update documentation map and refine testing guidelines** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  Add the docs/dev/ directory to the code organization reference and
  standardize formatting in the testing documentation. This is an
  internal change.

  ---------

- **insphere\_lifted is 5.3x faster in 3D (15.5 ns vs 81.7 ns)** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

- **Random query test: 3.75x faster (20.0 µs vs 75.0 µs for 1000 queries)** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

- **insphere\_lifted consistently fastest across all dimensions** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  Performance gains attributed to la-stack v0.2.0's closed-form determinants for D=1-4.

  Changes:

- **src/geometry/kernel.rs: Switch FastKernel to use insphere\_lifted()** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  Expected impact: 5-6x improvement in incremental insertion hot path.

  All tests pass (1279 unit tests, 505 doctests, full CI green).

  Resolves: #206

- **Document benchmark results showing insphere\_lifted is 5.3x faster in 3D** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

- **Mark insphere\_lifted as the recommended high-performance implementation** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

- **Explain performance gains from relative coordinates and la-stack v0.2.0's** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  closed-form determinants for D=1-4

  Error handling improvement:

- **When insphere\_lifted returns CellValidationError::CoordinateConversion,** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  forward the original source error instead of stringifying it

- **Only wrap non-conversion errors in new CoordinateConversionError** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

- **All warnings reference RobustKernel and follow FastKernel warning pattern** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  Testing improvements:

- **Each test validates orientation and asserts insphere\_lifted matches insphere** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

- **Ensures correctness for even dimensions (2D, 4D) and odd dimensions (3D, 5D)** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  All 20 predicate tests pass. Documentation builds without warnings.

  Addresses inline code review comments for issue #206.

- **Changed: refactor predicate parity tests and add FastKernel error cases** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  Introduce a `check_insphere_parity` helper function to deduplicate test
  logic for parity sign checks across 2D-5D. Add coverage for the
  `InsufficientVertices` and `DegenerateSimplex` error paths in the
  `FastKernel::in_sphere` implementation. This is an internal change.

  Refs: #206

  ---------

- **Enrich the soft post-condition diagnostic in** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  normalize_and_promote_positive_orientation with the count of
  residual negative cells and a sample of up to 5 CellKeys.

- **Change all convenience constructors (new, new\_with\_topology\_guarantee,** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  new_with_options, empty, etc.) to use RobustKernel<f64>

- **Change builder build() default to RobustKernel<T>** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

- **Update type annotations across tests, benches, and doc tests** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

- **Preserve FastKernel in tests that explicitly test it via with\_kernel()** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

- **Changed: use RobustKernel for random generation and 3D examples** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)
...
- **refactor: unify RobustKernel construction and use OnSuspicion validation** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

- **Change ValidationPolicy::Always → OnSuspicion during batch construction** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  in both build_with_kernel_inner_seeded variants to avoid O(n²) full
  validation on every insertion

- **Clarify toroidal\_periodic docs in builder.rs: reliability depends on the** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  kernel type passed to build_with_kernel, not the method itself

  Related: #228

- **Changed: refine error handling and API guidelines in AGENTS.md** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  Establish clearer distinctions between fallible and infallible public
  APIs. Recommend using Option for lookups and deferring builder errors
  to the final build method to ensure consistent error propagation across
  the library.

- **Soften post-condition in normalize\_and\_promote\_positive\_orientation:** [`c181f28`](https://github.com/acgetchell/delaunay/commit/c181f28)
...
- **Changed: Improve 3D incremental prefix debug harness** [`515dade`](https://github.com/acgetchell/delaunay/commit/515dade)
...
- **Changed: Enhance Codacy CI reliability and performance** [`b980630`](https://github.com/acgetchell/delaunay/commit/b980630)
...
- **Changed: Make Codacy analysis step continue on error** [`24a1ad6`](https://github.com/acgetchell/delaunay/commit/24a1ad6)
...
- **Remove dead \`interpret\_insphere\_determinant\` function** [`fed429f`](https://github.com/acgetchell/delaunay/commit/fed429f)

- **Remove adaptive\_tolerance / manual threshold comparison from robust\_orientation()** [`2869cfe`](https://github.com/acgetchell/delaunay/commit/2869cfe)

- **Remove \`dimension\_is\_even\`, \`parity\_sign\`, and \`orient\_sign\` variables** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  Stack-matrix dispatch cleanup:

- **Extract try\_d\_lt4\_global\_repair\_fallback helper to eliminate** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  duplicated repair-or-abort logic between the stats and non-stats
  branches of insert_remaining_vertices_seeded.

- **chore: update docs, remove old files** [`18679dc`](https://github.com/acgetchell/delaunay/commit/18679dc)

### Fixed

- **Fixed: handle det\_sign\_exact errors in orientation\_from\_matrix** [`a62437f`](https://github.com/acgetchell/delaunay/commit/a62437f)

  Update the orientation predicate to catch and recover from errors
  returned by exact determinant calculations. This ensures the adaptive
  tolerance fallback is used if non-finite entries exist in the matrix
  outside the active k×k block, preventing potential panics. Also updates
  sysinfo to v0.38.4.

  Refs: #235

- **docs: update predicate docs and improve error handling** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

  Update insphere predicate documentation with comprehensive benchmark results
  and improve error propagation in FastKernel::in_sphere.

  Documentation updates:

- **Fix FastKernel::in\_sphere to preserve CoordinateConversionError metadata** [`91e290f`](https://github.com/acgetchell/delaunay/commit/91e290f)

- **refactor: deduplicate D<4 repair fallback and improve diagnostics** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

- **fix: switch default kernel from FastKernel to RobustKernel** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

- **Fixed: enforce per-insertion validation for PLManifoldStrict topology** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)
...
- **docs: clarify #228 not fully resolved** [`14ff1b3`](https://github.com/acgetchell/delaunay/commit/14ff1b3)

  Commit 176eac49 made progress on #228 by switching the default
  kernel from FastKernel to RobustKernel, but the core issue
  (3D flip-repair non-convergence at 1000 points with seeded repro)
  remains unresolved.

  Related to #228

- **Replace enlarged local repair fallback with global** [`c181f28`](https://github.com/acgetchell/delaunay/commit/c181f28)
...
- **Gate global repair fallback on a new ConstructionOptions field** [`c181f28`](https://github.com/acgetchell/delaunay/commit/c181f28)
...
- **Fixed: Ensure deterministic sorting and enforce coherent orientation** [`c0e4d4f`](https://github.com/acgetchell/delaunay/commit/c0e4d4f)
