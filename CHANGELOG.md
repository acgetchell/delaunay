...
- **Changed: Refactors topology guarantee and manifold validation** [`8b0e95e`](https://github.com/acgetchell/delaunay/commit/8b0e95e)

- **Changed: Updates topology guarantee defaults and validation** [`100625e`](https://github.com/acgetchell/delaunay/commit/100625e)

- **Changed: Improves PL-manifold validation with vertex-link check** [`04a6e47`](https://github.com/acgetchell/delaunay/commit/04a6e47)

### Fixed

- **Fixed: Corrects triangulation perturbation logic** [`5d4f1d0`](https://github.com/acgetchell/delaunay/commit/5d4f1d0)

- **Fixed: Detects non-PL manifold vertex links** [`321cd84`](https://github.com/acgetchell/delaunay/commit/321cd84)
