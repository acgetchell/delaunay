...
## [Unreleased](https://github.com/acgetchell/delaunay/compare/v0.5.2...HEAD)
...
- **feat(geometry): Add quality metrics and integrate with topology repair** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)
...
- **Added "inradius" to cspell.json** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **test(geometry): Add comprehensive tests for quality metrics and utility** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)
...
- **Added academic references to REFERENCES.md (Knupp, Parthasarathy, etc.)** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add special case for 1D inradius calculation to prevent division by zero** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

  (1D surface facet measure is 0, so inradius = length/2)

- **Add "sysinfo" to cspell dictionary** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)
...
- **Add 708 lines of new tests for radius\_ratio and normalized\_volume** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add 9 property-based tests (proptest) for geometric invariances:** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add 22 deterministic unit tests covering:** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add hybrid scoring when only partial quality scores available** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add topology rebuild after cell removals when no duplicates found** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add safety constants and better debug messages** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

  Geometry utilities:

- **Add degeneracy checks to simplex\_volume for 1D, 2D, 3D cases** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add BENCH\_PRINT\_MEM env var to control memory logging** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add "unscored" to spell-check dictionary** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add BENCH\_PRINT\_MEM env var to control memory logging** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

  Core TDS improvements (fix_invalid_facet_sharing):

- **Add early return optimization when validation passes** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add degeneracy checks: return errors instead of zero for degenerate facets** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

- **Add memory unit verification: log "bytes → KiB" conversion on first call** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

  when BENCH_PRINT_MEM is set to prevent silent drift

- **Separate TDS memory from setup overhead: add tds\_delta field to** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)

  MemoryInfo to isolate actual triangulation allocation from RNG/point/
  vertex overhead

- **Add 'callsites' and 'overcounted' to cspell dictionary** [`c707b09`](https://github.com/acgetchell/delaunay/commit/c707b09)
...
- **Refactor Vertex, add Phase 3 checklist** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)
...
- **Added: Implements property-based testing framework** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)
...
- **Implementing dimension checks with error handling.** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **Adding comprehensive property-based tests to verify** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

  mathematical properties of geometric predicates.

  These changes improve performance, memory efficiency, and robustness.

- **Tentatively execute insertion algorithm (may create cells)** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **Add topology mathematical terms to cspell dictionary** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **Add trait bound documentation for ComplexField requirement** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

  Documentation:

- **Add cspell dictionary entries for technical terms** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **doc\_markdown: Add backticks around \`FacetView\` API reference** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **too\_long\_first\_doc\_paragraph: Add paragraph break after NOTE** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

  Also includes:

- **Check for explicit category prefixes first (Fixed:, Added:, Removed:, etc.)** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **Reorder keyword priority: action verbs (add/remove/fix) before** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

  descriptive terms (security/deprecated)

  **Testing:**

- **Added regression test \`test\_categorize\_explicit\_prefix\_takes\_precedence\`** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **Check for explicit category prefixes first (Fixed:, Added:, Removed:, etc.)** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)

- **Match both short forms (fix:, add:) and past tense (fixed:, added:)** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)
...
- **Added \`test\_categorize\_explicit\_prefix\_takes\_precedence\` for regression** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)
...
- **All 106 Python tests pass (added 2 new test methods)** [`2db8acd`](https://github.com/acgetchell/delaunay/commit/2db8acd)
