...
- **Install the correct Rust version** (1.93.1) if you don't have it
...
```text
info: syncing channel updates for '1.93.1-<your-platform>'
...
```bash
rustup show
# Should show: active toolchain: 1.93.1-<platform> (overridden by '/path/to/delaunay/rust-toolchain.toml')
```
